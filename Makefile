...
PACKAGE = exg-wfdb
SRCDIR = "/Users/kbajalc/Projects/exg-wfdb"
LONGDATE = 28 June 2025
SHORTDATE = JUNE 2025
YEAR = 2025
ARCH = x86_64-Darwin
BUILD_CC = $(CC)
...
# VDEFS.
CCDEFS = -DWFDB_FLAC_SUPPORT $(VDEFS) -DWFDB_LARGETIME  -DNOVALUES_H
...
# WFDB library.
LDFLAGS = -L$(DESTDIR)$(LIBDIR) -lwfdb -Wl,-rpath,/usr/local/lib
...
WCFLAGS = $(WMFLAGS) -g -O $(CCDEFS) $(LC) -I$(DESTDIR)$(INCDIR) -I$(OWINCDIR) -I$(XINCDIR)
